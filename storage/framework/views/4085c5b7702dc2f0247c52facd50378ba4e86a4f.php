													...
													<?php $__currentLoopData = $payment_platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
															<label class="gateway btn rounded p-0" href="#<?php echo e($payment_platform->name); ?>Collapse" data-bs-toggle="collapse">
																...
																class="<?php if($payment_platform->name == 'Paystack' || $payment_platform->name == 'Razorpay' || $payment_platform->name == 'PayTR' || $payment_platform->name == 'PayPal'): ?> payment-image	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\Abdulhadi Project\aimagicx-final\resources\views/user/plans/subscribe-checkout.blade.php ENDPATH**/ ?>